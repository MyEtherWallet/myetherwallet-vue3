<template>
  <div class="mew-component--dapp-submission">
        ...
        <v-row>
          ...
          *****************************************************************
          ...
          <v-col cols="12" md="8">
            ...
            <mew-input
              v-model="state.form.dappName"
              :rules="[state.rules.noEmptyString]"
              outlined
            />
            ...
            <div class="section-title">
              ...
              <div>
                ...
                <v-chip
                  v-for="(tag, tagKey) in state.tagsList"
                  :key="tagKey"
                  x-small
            ...
            <v-combobox
              ...
              :rules="[state.rules.noEmptyArray]"
              multiple
              chips
              outlined
            />
            ...
            <mew-input
              v-model="state.form.contractAddress"
              outlined
              :rules="[
                state.rules.noEmptyString,
                state.rules.requireValidEthAddress
              ]"
            />
            ...
            <mew-input v-model="state.form.dappWebsite" outlined />
            ...
            <div class="border">
              <v-radio-group
                v-model="state.form.contractAudit"
                :rules="[state.rules.noNull]"
                column
                class="mt-0"
              >
            ...
            <div class="section-title">
              <div class="mew-heading-3">
                {{
                  ...
                  lokalise('dappsSubmission.about-your-dapp.mock-flow-title')
                }}
                <span class="mew-label">
                  ({{
                    $t('dappsSubmission.required') ||
              ...
              <div>
                {{
                  ...
                  lokalise('dappsSubmission.about-your-dapp.mock-requirements')
                }}
              </div>
            </div>
            <div>
            ...
            <div class="border">
              <v-file-input
                v-model="state.form.mockFlowFile"
                :rules="[state.rules.noNull]"
            ...
            <div class="section-title">
              <div class="mew-heading-3">
                {{
                  ...
                  lokalise('dappsSubmission.about-your-dapp.dapp-icon-title')
                }}
                <span class="mew-label">
                  ({{
                    $t('dappsSubmission.required') ||
            ...
            <div class="border">
              <v-file-input
                v-model="state.form.dappIconFile"
                :rules="[state.rules.noNull]"
            ...
            <mew-input
              ...
              :rules="[state.rules.noEmptyString, state.rules.email]"
            />
            ...
            <v-combobox
              v-model="state.form.socialLinks"
              :rules="[state.rules.noEmptyArray]"
              multiple
              chips
              outlined
            ...
            <div class="section-title">
              <div class="mew-heading-3">
                {{
                  ...
                  lokalise('dappsSubmission.about-your-team.company-website')
                }}
              </div>
            </div>
            <mew-input v-model="state.form.companyWebsite" />
            ...
            <div class="section-title">
              <div class="mew-heading-3">
                {{
                  ...
                  lokalise('dappsSubmission.about-your-team.additional-notes')
                }}
              </div>
              <div>
                {{
                  $t('dappsSubmission.about-your-team.notes-placeholder') ||
                  lokalise('dappsSubmission.about-your-team.notes-placeholder')
                }}
              </div>
            </div>
            <v-textarea
              v-model="state.form.additionalNotes"
              outlined
              counter
              maxlength="300"
            ></v-textarea>
            ...
            -->
            <mew-button
              :disabled="state.validRequiredFormsRate !== 100 ? true : false"
            ...
            <div
              v-show="state.validRequiredFormsRate !== 100"
          ...
          <v-col cols="12" md="4">
            <div style="position: sticky; top: 0">
              ...
              <div class="greyLight pa-6 d-none d-md-block">
                ...
                <v-progress-linear
                  v-model="state.validRequiredFormsRate"
                  color="greenPrimary"
                  height="25"
                  class="mt-5"
                >
    ...
    =================================================================
    -->
    <v-dialog v-model="state.formSubmissionSuccessful" width="500">
    ...
    <v-dialog v-model="state.formSubmissionFailed" width="500">
      <div class="pa-5 white">
...
interface StateForm {
  ...
  category: null | any;
  usMarket: null | any;
  mockFlowFile: null | any;
  dappIconFile: null | any;
  bannerFile: null | any;
  dappWebsite: string;
  contractAudit: null | any;
  dappStatus: null | any;
  authors: string;
  fullName: string;
  email: string;
...
interface State {
  ...
  imgDappIcon: string;
  imgBanner: string;
  validRequiredFormsRate: number;
  areAllRequiredFormsValid: boolean;
  formSubmissionSuccessful: boolean;
  formSubmissionFailed: boolean;
  form: StateForm;
  itemsCategory: Array<string>;
  tagsList: Array<string>;
  rules: {
    noEmptyString: (value: any) => boolean | string;
    noEmptyArray: (value: any) => boolean | string;
    noNull: (value: any) => boolean | string;
    requireValidEthAddress: (value: any) => boolean | string;
...
const fillTags = (e: any) => {
  const item = e.currentTarget.getAttribute('val');
  if (state.form.tags.indexOf(item) === -1) {
    state.form.tags.push(item);
  }
};
const imgPreview = (e: any, targetVar: string) => {
  if (e) {
    state[targetVar] = URL.createObjectURL(e);
  } else {
    state[targetVar] = '';
  }
};
const submitForm = () => {
  ...
  state.areAllRequiredFormsValid = this.$refs.form.validate();

  if (state.areAllRequiredFormsValid) {
    axios({
      method: 'post',
      ...
      .then(() => {
        state.formSubmissionSuccessful = true;
      })
      .catch(() => {
        state.formSubmissionFailed = true;
      });
  }
};
...
const progress = () => {
  ...
  const validFormCount =
    (state.form.dappName === '' ? 0 : 1) +
    (state.form.category === null ? 0 : 1) +
    (state.form.tags.length === 0 ? 0 : 1) +
    (state.form.description === '' ? 0 : 1) +
    (state.form.contractAddress === '' ? 0 : 1) +
    (state.form.usMarket === null ? 0 : 1) +
    (state.form.dappStatus === null ? 0 : 1) +
    (state.form.mockFlowFile === null ? 0 : 1) +
    (state.form.dappIconFile === null ? 0 : 1) +
    (state.form.bannerFile === null ? 0 : 1) +
    (state.form.authors === '' ? 0 : 1) +
    (state.form.fullName === '' ? 0 : 1) +
    (state.form.email === '' ? 0 : 1) +
    (state.form.socialLinks.length === 0 ? 0 : 1);

  state.validRequiredFormsRate = (validFormCount / 14) * 100;
};
</script>
