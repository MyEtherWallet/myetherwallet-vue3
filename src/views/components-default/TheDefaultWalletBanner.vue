  ...
  >
    ...
    >
      ...
      <v-icon class="ml-2" color="greenPrimary" size="12">{{
        state.isExpanded ? 'mdi-chevron-up' : 'mdi-chevron-down'
      }}</v-icon>
    </div>
      ...
      >
        ...
        >
          ...
          <div
            :class="[
              'btn-container',
              state.isExpanded ? 'bottom-space' : 'ml-7'
            ]"
          >
            <a
              v-for="(btn, idx) in state.storeButtons"
              :key="idx"
              target="_blank"
