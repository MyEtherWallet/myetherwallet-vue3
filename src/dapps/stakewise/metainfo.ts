...
import layout from './TheStakewiseLayout.vue';
import ModuleStakewiseRewards from './modules/ModuleStakewiseRewards.vue';
import ModuleStakewiseStake from './modules/ModuleStakewiseStake.vue';
