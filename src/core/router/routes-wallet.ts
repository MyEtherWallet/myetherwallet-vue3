...
export default {
  ...
  children: [
    ...
    //   component: () => import('@/views/layouts-wallet/TheDashboardLayout.vue'),
    //   meta: {
    //     noAuth: false
    //   }
    // },
    ...
    //   component: () => import('@/modules/settings/ModuleSettings.vue'),
    //   meta: {
    //     noAuth: false
    //   }
    // },
    ...
    //   component: () =>
    //     import('@/views/layouts-wallet/TheSendTransactionLayout.vue'),
    //   props: true,
    //   meta: {
    //     noAuth: false
    //   }
    ...
    //   component: () => import('@/views/layouts-wallet/TheNFTManagerLayout.vue'),
    //   children: [
    //     {
    //       path: ROUTES_WALLET.NFT_MANAGER_SEND.PATH,
    //       name: ROUTES_WALLET.NFT_MANAGER_SEND.NAME,
    //       component: () =>
    //         import('@/modules/nft-manager/components/NftManagerSend.vue'),
    //       meta: {
    //         noAuth: false
    //       }
    //     }
    ...
    //   component: () => import('@/views/layouts-wallet/TheSwapLayout.vue'),
    //   props: swapProps,
    ...
    //   component: () =>
    //     import('@/views/layouts-wallet/TheDappCenterLayout.vue.vue'),
    //   children: DappRoutes,
    //   meta: {
    //     noAuth: false
    //   }
    ...
    //   component: () =>
    //     import('@/views/layouts-wallet/TheDeployContractLayout.vue'),
    //   meta: {
    //     noAuth: false
    //   }
    // },
    ...
    //   component: () =>
    //     import('@/views/layouts-wallet/TheInteractContractLayout.vue'),
    //   meta: {
    //     noAuth: false
    //   }
    // },
